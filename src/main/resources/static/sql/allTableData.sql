...
INSERT INTO PACKAGE_T VALUES(PACKAGE_SEQ.NEXTVAL, 1, 1, '인기 많은 묻지마여행1', '예약가능', '친구와 함께 추천', '항공없음', '아무데서 먹고자고싸고', '묻지마여행은 이래저래', '호텔정보는 이렇습니다!', 55000, '위험한사항이있어요', TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 0, 1, 30, 1);
INSERT INTO PACKAGE_T VALUES(PACKAGE_SEQ.NEXTVAL, 1, 1, '인기 많은 묻지마여행2', '예약가능', '친구와 함께 추천', '항공없음', '아무데서 먹고자고싸고', '묻지마여행은 이래저래', '호텔정보는 이렇습니다!', 55000, '위험한사항이있어요', TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 0, 1, 30, 1);
COMMIT;
...
INSERT INTO FAQ_T VALUES(FAQ_SEQ.NEXTVAL, 4, '회원가입은 어떻게 하나요?', '우측 상단에서 회원가입 서비스 이용이 가능합니다. 감사합니다.', TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'));
