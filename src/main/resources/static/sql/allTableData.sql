...
CREATE TABLE PRODUCT_IMAGE_T (
	...
	THUMBNAIL	    VARCHAR2(300 BYTE)	NULL,      -- 썸네일
    ...
    CONSTRAINT FK_PACKAGE_IMAGE  FOREIGN KEY(PACKAGE_NO)  REFERENCES PACKAGE_T(PACKAGE_NO) ON DELETE SET NULL,
    CONSTRAINT FK_HOTEL_IMAGE    FOREIGN KEY(HOTEL_NO)    REFERENCES HOTEL_T(HOTEL_NO)     ON DELETE SET NULL
);
