...
CREATE TABLE PRODUCT_IMAGE_T (
    ...
    CONSTRAINT FK_HOTEL_IMAGE    FOREIGN KEY(HOTEL_NO)    REFERENCES HOTEL_T(HOTEL_NO)     ON DELETE CASCADE
);
...
CREATE TABLE REVIEW_T (
	...
	RESERVE_NO	    NUMBER	            NOT NULL,  -- 예약 번호   (FK)
	PACKAGE_NO	    NUMBER	            NULL,      -- 패키지 번호 (FK)
	HOTEL_NO	    NUMBER	            NULL,      -- 호텔 번호   (FK)
...
-- 객실 기간별 가격 등록 ********************************************************
-- 호텔 1 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (1, 100, '2024-01-01', '2024-03-31', 150, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (2, 120, '2024-01-01', '2024-03-31', 180, '2024-04-01', '2024-06-30', 230, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (3, 80, '2024-01-01', '2024-03-31', 120, '2024-04-01', '2024-06-30', 160, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 2 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (4, 90, '2024-01-01', '2024-03-31', 130, '2024-04-01', '2024-06-30', 180, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (5, 110, '2024-01-01', '2024-03-31', 160, '2024-04-01', '2024-06-30', 210, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (6, 70, '2024-01-01', '2024-03-31', 110, '2024-04-01', '2024-06-30', 150, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 3 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (7, 120, '2024-01-01', '2024-03-31', 180, '2024-04-01', '2024-06-30', 230, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (8, 150, '2024-01-01', '2024-03-31', 200, '2024-04-01', '2024-06-30', 250, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (9, 100, '2024-01-01', '2024-03-31', 150, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 4 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (10, 80, '2024-01-01', '2024-03-31', 120, '2024-04-01', '2024-06-30', 160, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (11, 100, '2024-01-01', '2024-03-31', 150, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (12, 60, '2024-01-01', '2024-03-31', 100, '2024-04-01', '2024-06-30', 140, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 5 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (13, 70, '2024-01-01', '2024-03-31', 110, '2024-04-01', '2024-06-30', 150, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (14, 90, '2024-01-01', '2024-03-31', 130, '2024-04-01', '2024-06-30', 170, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (15, 50, '2024-01-01', '2024-03-31', 80, '2024-04-01', '2024-06-30', 120, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 6 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (16, 110, '2024-01-01', '2024-03-31', 160, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (17, 130, '2024-01-01', '2024-03-31', 180, '2024-04-01', '2024-06-30', 220, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (18, 90, '2024-01-01', '2024-03-31', 120, '2024-04-01', '2024-06-30', 160, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 7 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (19, 120, '2024-01-01', '2024-03-31', 180, '2024-04-01', '2024-06-30', 230, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (20, 150, '2024-01-01', '2024-03-31', 200, '2024-04-01', '2024-06-30', 250, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (21, 100, '2024-01-01', '2024-03-31', 150, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 8 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (22, 80, '2024-01-01', '2024-03-31', 120, '2024-04-01', '2024-06-30', 160, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (23, 100, '2024-01-01', '2024-03-31', 150, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (24, 60, '2024-01-01', '2024-03-31', 100, '2024-04-01', '2024-06-30', 140, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 9 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (25, 70, '2024-01-01', '2024-03-31', 110, '2024-04-01', '2024-06-30', 150, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (26, 90, '2024-01-01', '2024-03-31', 130, '2024-04-01', '2024-06-30', 170, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (27, 50, '2024-01-01', '2024-03-31', 80, '2024-04-01', '2024-06-30', 120, '2024-07-01', '2024-08-31');

COMMIT;

-- 호텔 10 객실 가격
INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (28, 110, '2024-01-01', '2024-03-31', 160, '2024-04-01', '2024-06-30', 200, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (29, 130, '2024-01-01', '2024-03-31', 180, '2024-04-01', '2024-06-30', 220, '2024-07-01', '2024-08-31');

INSERT INTO ROOMPRICE_T (ROOM_NO, BI_PRICE, BS_DATE, BE_DATE, JUN_PRICE, JS_DATE, JE_DATE, SUNG_PRICE, SS_DATE, SE_DATE)
VALUES (30, 90, '2024-01-01', '2024-03-31', 120, '2024-04-01', '2024-06-30', 160, '2024-07-01', '2024-08-31');

COMMIT;

-- 상품 사진 등록****************************************************************
INSERT INTO PRODUCT_IMAGE_T VALUES(PRODUCT_IMAGE_SEQ.NEXTVAL, 1, 1, 1, '썸네일사진', '경로입니다');
INSERT INTO PRODUCT_IMAGE_T VALUES(PRODUCT_IMAGE_SEQ.NEXTVAL, 2, 2, 1, '썸네일사진', '경로입니다');
INSERT INTO PRODUCT_IMAGE_T VALUES(PRODUCT_IMAGE_SEQ.NEXTVAL, 3, 3, 1, '썸네일사진', '경로입니다');
INSERT INTO PRODUCT_IMAGE_T VALUES(PRODUCT_IMAGE_SEQ.NEXTVAL, 4, 4, 1, '썸네일사진', '경로입니다');
INSERT INTO PRODUCT_IMAGE_T VALUES(PRODUCT_IMAGE_SEQ.NEXTVAL, 5, 5, 1, '썸네일사진', '경로입니다');
COMMIT;

-- ******************************************************************************

-- 예약 등록
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '잠실', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 112000, 3, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '서울역', 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 56000, 4, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '고속버스터미널', 0, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 3, 168000, 5, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '서울역', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 110000, 6, 13, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '잠실', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 3, 165000, 7, 13, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '서울역', 0, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 242000, 8, 9, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 0, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 80, 7, NULL, 1, 3);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 100, 8, NULL, 1, 1);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 90, 9, NULL, 2, 4);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 70, 10, NULL, 2, 6);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 70, 11, NULL, 5, 13);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 110, 4, NULL, 10, 28);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 130, 5, NULL, 10, 29);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, NULL, 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 3, 90, 6, NULL, 10, 30);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '잠실', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 112000, 3, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '서울역', 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 1, 56000, 4, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '고속버스터미널', 0, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 3, 168000, 5, 1, NULL, NULL);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_CHAR(SYSDATE,'YYYY/MM/DD'), '요청사항', 0, '서울역', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'), TO_CHAR(SYSDATE,'YYYY/MM/DD'), 2, 110000, 6, 13, NULL, NULL);
...
INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'F', '01033332222', 0, 7);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'F', '01066665555', 0, 8);
INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'F', '01012123434', 0, 8);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'F', '01034345566', 0, 9);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '박성인', '19900101', 'F', '01043214321', 0, 10);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '나성인', '19900101', 'F', '01066665555', 0, 11);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '장성인', '19900101', 'M', '01044443333', 0, 12);
INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '부성인', '19900101', 'M', '01055554444', 0, 12);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '이성인', '19900101', 'F', '01077776666', 0, 13);

INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'F', '01099998888', 0, 14);
INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김성인', '19900101', 'M', '01088887777', 0, 14);
INSERT INTO TOURIST_T VALUES(TOURIST_SEQ.NEXTVAL, '김소아', '19900101', 'F', '01099998888', 1, 14);
COMMIT;
...
-- 리뷰 등록 ********************************************************************
-- 패키지 리뷰
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 1, 1, NULL, '너무 행복했습니다!', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 2, 1, NULL, '너무 좋았습니다!', 3, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 5, 3, 1, NULL, '별로습니다!', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 6, 4, 2, NULL, '너무 행복했습니다!', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 7, 5, 3, NULL, '너무 즐거웠습니다!', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 8, 6, 13, NULL, '너무 재밌었어요!', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 7, 13, NULL, '너무 행복했습니다!', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 8, 12, NULL, '와 진짜 별로!', 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 5, 9, 10, NULL, '강추강추!', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
COMMIT;

-- 호텔 리뷰
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 10, NULL, 10, '와! 벌써 또 가고싶어요', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 11, NULL, 10, '제가 가본 호텔중 최고에요', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 5, 11, NULL, 9, '좋았어요. 깔끔해요!', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 6, 12, NULL, 9, '꽤 괜찮았어요~', 3, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 7, 13, NULL, 8, '솔직히 또 가고싶진 않네요', 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 8, 14, NULL, 8, '음~ 나쁘진 않아요..', 3, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 9, 15, NULL, 8, '객실 상태는 괜찮은데 서비스가 영..', 3, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 6, 16, NULL, 7, '여긴 진자 레전드 별 다섯개', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 10, 17, NULL, 7, '전반적으로 만족스러웠습니다~', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 18, NULL, 7, '가족들이랑 내년에 또 가기로 했습니다~', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 5, 19, NULL, 7, '재방문 의사 있어요 굿~', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 5, 20, NULL, 4, '잘 지내다 왔어요~', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 7, 21, NULL, 3, '잘 지내다 왔지만.. 또 가진 않을듯..', 3, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 11, 22, NULL, 3, '솔직히 위생이 의심스러움', 2, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 12, 23, NULL, 2, '담에도 여기 이용하려구요~', 5, TO_CHAR(SYSDATE,'YYYY/MM/DD'));

INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 24, NULL, 1, '잘 지내고 잘 놀다 왔습니다~', 4, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 25, NULL, 1, '와.. 객실상태.. 복불복인가봐요.. 관리를 뭐 이런식으로..', 1, TO_CHAR(SYSDATE,'YYYY/MM/DD'));
